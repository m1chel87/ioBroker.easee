...
const easeeIds = {
  ...
  80: ".status.chargerFirmware",
  96: ".status.reasonForNoCurrent",
  102: ".config.smartCharging",
  103: ".status.cableLocked",
  109: ".status.chargerOpMode",
  114: ".status.outputCurrent",
  120: ".status.totalPower",
  122: ".status.energyPerHour",
  124: ".status.lifetimeEnergy",
  132: ".status.wiFiRSSI",
  150: ".status.TempMax",
  108: ".status.userIdToken", // User ID token from RFID reading, byte-reversed on older firmware (handled in main.js)
  128: ".status.userIdToken", // User ID token from RFID reading
  //xx: ".status.voltage",
  //xx: ".status.isOnline",
